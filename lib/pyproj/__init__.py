...
# uses C extension (from Gerald Evenden's libproject)
class _Geod(_geod.Geod):
     """
     ...
     def __new__(self, initstring=None, **kwargs):
         ...
         >>> from pyproj import _Geod
         >>> g = _Geod(ellps='clrk66') # Use Clarke 1966 ellipsoid.
         ...
         >>> g2 = _Geod('+ellps=clrk66') # use proj4 style initialization string
