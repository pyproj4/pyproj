/* Generated by Cython 0.13 on Tue Sep 14 12:38:45 2010 */
...
/* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":5
 * include "_pyproj.pxi"
 * 
 * cdef class Geod:             # <<<<<<<<<<<<<<
...
/* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":7
 * cdef class Geod:
 *     cdef GEODESIC_T geodesic_t
 *     cdef public object geodstring             # <<<<<<<<<<<<<<
...
/* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":8
 *     cdef GEODESIC_T geodesic_t
 *     cdef public object geodstring
 *     cdef public object proj_version             # <<<<<<<<<<<<<<
 *     cdef char *geodinitstring
...
/* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":11
 *     cdef char *geodinitstring
 * 
...
static int __pyx_pf_5_geod_4Geod___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":14
 *         cdef GEODESIC_T GEOD_T
 *         # setup geod initialization string.
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":15
 *         # setup geod initialization string.
 *         self.geodstring = geodstring
 *         self.geodinitstring = PyString_AsString(self.geodstring)             # <<<<<<<<<<<<<<
 *         # initialize projection
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":17
 *         self.geodinitstring = PyString_AsString(self.geodstring)
 *         # initialize projection
 *         self.geodesic_t = GEOD_init_plus(self.geodinitstring, &GEOD_T)[0]             # <<<<<<<<<<<<<<
 *         if pj_errno != 0:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":18
 *         # initialize projection
 *         self.geodesic_t = GEOD_init_plus(self.geodinitstring, &GEOD_T)[0]
 *         if pj_errno != 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":19
 *         self.geodesic_t = GEOD_init_plus(self.geodinitstring, &GEOD_T)[0]
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<<
 *         self.proj_version = PJ_VERSION/100.
 * 
 */
    __pyx_t_2 = PyBytes_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":20
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))
 *         self.proj_version = PJ_VERSION/100.             # <<<<<<<<<<<<<<
 * 
 *     def __reduce__(self):
 */
  __pyx_t_2 = PyFloat_FromDouble((PJ_VERSION / 100.)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
...
/* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":22
 *         self.proj_version = PJ_VERSION/100.
 * 
 *     def __reduce__(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5_geod_4Geod___reduce__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":24
 *     def __reduce__(self):
 *         """special method that allows pyproj.Geod instance to be pickled"""
 *         return (self.__class__,(self.geodstring,))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":39
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenlons) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &buflenlats) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":41
 *         if PyObject_AsWriteBuffer(lats, &latdata, &buflenlats) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(az, &azdat, &buflenaz) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":43
 *         if PyObject_AsWriteBuffer(az, &azdat, &buflenaz) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(dist, &distdat, &buflend) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":46
 *             raise RuntimeError
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":47
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<<
 *         ndim = buflenlons/_doublesize
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":48
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize             # <<<<<<<<<<<<<<
 *         lonsdata = <double *>londata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":49
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata             # <<<<<<<<<<<<<<
 *         latsdata = <double *>latdata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":50
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata             # <<<<<<<<<<<<<<
 *         azdata = <double *>azdat
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":51
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat             # <<<<<<<<<<<<<<
 *         distdata = <double *>distdat
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":52
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":53
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<<
 *             if radians:
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":54
 *         distdata = <double *>distdat
 *         for i from 0 <= i < ndim:
 *             if radians:             # <<<<<<<<<<<<<<
 *                 self.geodesic_t.p1.v = lonsdata[i]
 ...
 */
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":63
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 *                 self.geodesic_t.ALPHA12 = _dg2rad*azdata[i]
 *                 self.geodesic_t.DIST = distdata[i]             # <<<<<<<<<<<<<<
 *             geod_pre(&self.geodesic_t)
 ...
 *             if pj_errno != 0:
 */
      __pyx_t_4 = PyBytes_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 66; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
      __pyx_t_4 = PyBytes_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(((PyObject *)__pyx_t_4));
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":95
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats1, &latdata, &buflenlats) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         if PyObject_AsWriteBuffer(lons2, &azdat, &buflenaz) <> 0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":99
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats2, &distdat, &buflend) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         # process data in buffer
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":101
 *             raise RuntimeError
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Buffer lengths not the same")
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":102
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<<
 *         ndim = buflenlons/_doublesize
 ...
 */
    ...
    PyTuple_SET_ITEM(__pyx_t_3, 0, ((PyObject *)__pyx_kp_s_2));
    __Pyx_GIVEREF(((PyObject *)__pyx_kp_s_2));
    __pyx_t_4 = PyObject_Call(__pyx_builtin_RuntimeError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_Raise(__pyx_t_4, 0, 0);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":103
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize             # <<<<<<<<<<<<<<
 *         lonsdata = <double *>londata
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyNumber_Divide(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":104
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata             # <<<<<<<<<<<<<<
 *         latsdata = <double *>latdata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":105
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata             # <<<<<<<<<<<<<<
 *         azdata = <double *>azdat
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":106
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat             # <<<<<<<<<<<<<<
 *         distdata = <double *>distdat
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":107
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat             # <<<<<<<<<<<<<<
 *         errmsg = 'undefined inverse geodesic (may be an antipodal point)'
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":108
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat
 *         errmsg = 'undefined inverse geodesic (may be an antipodal point)'             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":109
 *         distdata = <double *>distdat
 *         errmsg = 'undefined inverse geodesic (may be an antipodal point)'
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<<
 *             if radians:
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = PyNumber_Multiply(__pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s___dg2rad); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = PyFloat_FromDouble((__pyx_v_latsdata[__pyx_v_i])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = PyNumber_Multiply(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":118
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 *                 self.geodesic_t.p2.v = _dg2rad*azdata[i]             # <<<<<<<<<<<<<<
 *                 self.geodesic_t.p2.u = _dg2rad*distdata[i]
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = PyNumber_Multiply(__pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s___dg2rad); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = PyFloat_FromDouble((__pyx_v_distdata[__pyx_v_i])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
 ...
 */
      ...
      __Pyx_GIVEREF(((PyObject *)__pyx_kp_s_3));
      __pyx_t_3 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_Raise(__pyx_t_3, 0, 0);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_3 = PyBytes_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_3 = 0;
      __pyx_t_3 = PyObject_Call(__pyx_builtin_RuntimeError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_Raise(__pyx_t_3, 0, 0);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s___rad2dg); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = PyFloat_FromDouble(((struct __pyx_obj_5_geod_Geod *)__pyx_v_self)->geodesic_t.ALPHA12); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = PyNumber_Multiply(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 * 
 */
      __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s___rad2dg); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = PyFloat_FromDouble(((struct __pyx_obj_5_geod_Geod *)__pyx_v_self)->geodesic_t.ALPHA21); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_3 = PyNumber_Multiply(__pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
/* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":133
 *             azdata[i] = self.geodesic_t.DIST
 * 
 *     def _npts(self, double lon1, double lat1, double lon2, double lat2, int npts, radians=False):             # <<<<<<<<<<<<<<
 *         """
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":146
 *             self.geodesic_t.p1.v = _dg2rad*lon1
 *             self.geodesic_t.p1.u = _dg2rad*lat1
 *             self.geodesic_t.p2.v = _dg2rad*lon2             # <<<<<<<<<<<<<<
 *             self.geodesic_t.p2.u = _dg2rad*lat2
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":153
 *         geod_pre(&self.geodesic_t)
 *         # distance increment.
 *         del_s = self.geodesic_t.DIST/(npts+1)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":155
 *         del_s = self.geodesic_t.DIST/(npts+1)
 *         # initialize output tuples.
 *         lats = ()             # <<<<<<<<<<<<<<
 *         lons = ()
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":161
 *             self.geodesic_t.DIST = i*del_s
 *             geod_for(&self.geodesic_t)
 *             if radians:             # <<<<<<<<<<<<<<
 *                 lats = lats + (self.geodesic_t.p2.u,)
 ...
 */
      ...
      __Pyx_GIVEREF(__pyx_t_2);
      __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_Add(((PyObject *)__pyx_v_lats), __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected tuple, got %.200s", Py_TYPE(__pyx_t_2)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(((PyObject *)__pyx_v_lats));
 ...
 */
      ...
      __Pyx_GIVEREF(__pyx_t_2);
      __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_Add(((PyObject *)__pyx_v_lons), __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected tuple, got %.200s", Py_TYPE(__pyx_t_2)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(((PyObject *)__pyx_v_lons));
 ...
 */
      ...
      __pyx_t_4 = 0;
      __pyx_t_4 = PyNumber_Add(((PyObject *)__pyx_v_lats), __pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (!(likely(PyTuple_CheckExact(__pyx_t_4))||((__pyx_t_4) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected tuple, got %.200s", Py_TYPE(__pyx_t_4)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(((PyObject *)__pyx_v_lats));
      __pyx_v_lats = ((PyObject *)__pyx_t_4);
      __pyx_t_4 = 0;

      /* "/mac_home/jwhitaker/python/pyproj/_geod.pyx":166
 *             else:
 *                 lats = lats + (_rad2dg*self.geodesic_t.p2.u,)
 *                 lons = lons + (_rad2dg*self.geodesic_t.p2.v,)             # <<<<<<<<<<<<<<
 *         return lons, lats
 */
      ...
      __Pyx_GIVEREF(__pyx_t_2);
      __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_Add(((PyObject *)__pyx_v_lons), __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 166; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected tuple, got %.200s", Py_TYPE(__pyx_t_2)->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 166; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(((PyObject *)__pyx_v_lons));
      __pyx_v_lons = ((PyObject *)__pyx_t_2);
      __pyx_t_2 = 0;
    }
