/* Generated by Cython 0.13 on Tue Sep 14 12:34:07 2010 */
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":12
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":7
...
static PyObject *__pyx_pf_5_proj_set_datapath(PyObject *__pyx_self, PyObject *__pyx_v_datapath) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":9
 * def set_datapath(datapath):
 *     cdef char *searchpath
 *     searchpath = PyString_AsString(datapath)             # <<<<<<<<<<<<<<
 *     pj_set_searchpath(1, &searchpath)
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":10
 *     cdef char *searchpath
 *     searchpath = PyString_AsString(datapath)
 *     pj_set_searchpath(1, &searchpath)             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":14
 * cdef class Proj:
 *     cdef projPJ projpj
 *     cdef public object proj_version             # <<<<<<<<<<<<<<
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":16
 *     cdef public object proj_version
 *     cdef char *pjinitstring
 *     cdef public object srs             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":18
 *     cdef public object srs
 * 
 *     def __new__(self, projstring):             # <<<<<<<<<<<<<<
...
static int __pyx_pf_5_proj_4Proj___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":20
 *     def __new__(self, projstring):
 *         # setup proj initialization string.
 *         self.srs = projstring             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":21
 *         # setup proj initialization string.
 *         self.srs = projstring
 *         self.pjinitstring = PyString_AsString(self.srs)             # <<<<<<<<<<<<<<
 *         # initialize projection
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":23
 *         self.pjinitstring = PyString_AsString(self.srs)
 *         # initialize projection
 *         self.projpj = pj_init_plus(self.pjinitstring)             # <<<<<<<<<<<<<<
 *         if pj_errno != 0:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":24
 *         # initialize projection
 *         self.projpj = pj_init_plus(self.pjinitstring)
 *         if pj_errno != 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":25
 *         self.projpj = pj_init_plus(self.pjinitstring)
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<<
 *         self.proj_version = PJ_VERSION/100.
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":26
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))
 *         self.proj_version = PJ_VERSION/100.             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":28
 *         self.proj_version = PJ_VERSION/100.
 * 
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
...
static void __pyx_pf_5_proj_4Proj___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":30
 *     def __dealloc__(self):
 *         """destroy projection definition"""
 *         pj_free(self.projpj)             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":32
 *         pj_free(self.projpj)
 * 
 *     def __reduce__(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5_proj_4Proj___reduce__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":34
 *     def __reduce__(self):
 *         """special method that allows pyproj.Proj instance to be pickled"""
 *         return (self.__class__,(self.srs,))             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":36
 *         return (self.__class__,(self.srs,))
 * 
 *     def _fwd(self, object lons, object lats, radians=False, errcheck=False):             # <<<<<<<<<<<<<<
 *         """
...
static PyObject *__pyx_pf_5_proj_4Proj__fwd(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":50
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":51
 *         # if buffer api is supported, get pointer to data buffers.
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenx) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         if PyObject_AsWriteBuffer(lats, &latdata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":52
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenx) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &bufleny) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":53
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &bufleny) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         # process data in buffer
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":55
 *             raise RuntimeError
 *         # process data in buffer
 *         if buflenx != bufleny:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":56
 *         # process data in buffer
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<<
 *         ndim = buflenx/_doublesize
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":57
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize             # <<<<<<<<<<<<<<
 *         lonsdata = <double *>londata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":58
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize
 *         lonsdata = <double *>londata             # <<<<<<<<<<<<<<
 *         latsdata = <double *>latdata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":59
 *         ndim = buflenx/_doublesize
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":60
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<<
 *             if radians:
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_5; __pyx_v_i++) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":61
 *         latsdata = <double *>latdata
 *         for i from 0 <= i < ndim:
 *             if radians:             # <<<<<<<<<<<<<<
 *                 projlonlatin.u = lonsdata[i]
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":62
 *         for i from 0 <= i < ndim:
 *             if radians:
 *                 projlonlatin.u = lonsdata[i]             # <<<<<<<<<<<<<<
 *                 projlonlatin.v = latsdata[i]
 ...
 */
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":63
 *             if radians:
 *                 projlonlatin.u = lonsdata[i]
 *                 projlonlatin.v = latsdata[i]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":65
 *                 projlonlatin.v = latsdata[i]
 *             else:
 *                 projlonlatin.u = _dg2rad*lonsdata[i]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":66
 *             else:
 *                 projlonlatin.u = _dg2rad*lonsdata[i]
 *                 projlonlatin.v = _dg2rad*latsdata[i]             # <<<<<<<<<<<<<<
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":67
 *                 projlonlatin.u = _dg2rad*lonsdata[i]
 *                 projlonlatin.v = _dg2rad*latsdata[i]
 *             projxyout = pj_fwd(projlonlatin,self.projpj)             # <<<<<<<<<<<<<<
 *             if errcheck and pj_errno != 0:
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":68
 *                 projlonlatin.v = _dg2rad*latsdata[i]
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 *             if errcheck and pj_errno != 0:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":69
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 *             if errcheck and pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<<
 *             # since HUGE_VAL can be 'inf',
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":72
 *             # since HUGE_VAL can be 'inf',
 *             # change it to a real (but very large) number.
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":73
 *             # change it to a real (but very large) number.
 *             if projxyout.u == HUGE_VAL:
 *                 lonsdata[i] = 1.e30             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":75
 *                 lonsdata[i] = 1.e30
 *             else:
 *                 lonsdata[i] = projxyout.u             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":76
 *             else:
 *                 lonsdata[i] = projxyout.u
 *             if projxyout.v == HUGE_VAL:             # <<<<<<<<<<<<<<
 *                 latsdata[i] = 1.e30
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":77
 *                 lonsdata[i] = projxyout.u
 *             if projxyout.v == HUGE_VAL:
 *                 latsdata[i] = 1.e30             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":79
 *                 latsdata[i] = 1.e30
 *             else:
 *                 latsdata[i] = projxyout.v             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":81
 *                 latsdata[i] = projxyout.v
 * 
 *     def _inv(self, object x, object y, radians=False, errcheck=False):             # <<<<<<<<<<<<<<
 *         """
...
static PyObject *__pyx_pf_5_proj_4Proj__inv(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":95
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":96
 *         # if buffer api is supported, get pointer to data buffers.
 *         if PyObject_AsWriteBuffer(x, &xdata, &buflenx) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         if PyObject_AsWriteBuffer(y, &ydata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":97
 *         if PyObject_AsWriteBuffer(x, &xdata, &buflenx) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(y, &ydata, &bufleny) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":98
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(y, &ydata, &bufleny) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         # process data in buffer
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":101
 *         # process data in buffer
 *         # (for numpy/regular python arrays).
 *         if buflenx != bufleny:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Buffer lengths not the same")
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":102
 *         # (for numpy/regular python arrays).
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<<
 *         ndim = buflenx/_doublesize
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":103
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize             # <<<<<<<<<<<<<<
 *         xdatab = <double *>xdata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":104
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize
 *         xdatab = <double *>xdata             # <<<<<<<<<<<<<<
 *         ydatab = <double *>ydata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":105
 *         ndim = buflenx/_doublesize
 *         xdatab = <double *>xdata
 *         ydatab = <double *>ydata             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":106
 *         xdatab = <double *>xdata
 *         ydatab = <double *>ydata
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<<
 *             projxyin.u = xdatab[i]
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_5; __pyx_v_i++) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":107
 *         ydatab = <double *>ydata
 *         for i from 0 <= i < ndim:
 *             projxyin.u = xdatab[i]             # <<<<<<<<<<<<<<
 *             projxyin.v = ydatab[i]
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":108
 *         for i from 0 <= i < ndim:
 *             projxyin.u = xdatab[i]
 *             projxyin.v = ydatab[i]             # <<<<<<<<<<<<<<
 *             projlonlatout = pj_inv(projxyin,self.projpj)
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":109
 *             projxyin.u = xdatab[i]
 *             projxyin.v = ydatab[i]
 *             projlonlatout = pj_inv(projxyin,self.projpj)             # <<<<<<<<<<<<<<
 *             if errcheck and pj_errno != 0:
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":110
 *             projxyin.v = ydatab[i]
 *             projlonlatout = pj_inv(projxyin,self.projpj)
 *             if errcheck and pj_errno != 0:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":111
 *             projlonlatout = pj_inv(projxyin,self.projpj)
 *             if errcheck and pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<<
 *             # since HUGE_VAL can be 'inf',
 *             # change it to a real (but very large) number.
 */
      __pyx_t_4 = PyBytes_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(((PyObject *)__pyx_t_4));
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":114
 *             # since HUGE_VAL can be 'inf',
 *             # change it to a real (but very large) number.
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":115
 *             # change it to a real (but very large) number.
 *             if projlonlatout.u == HUGE_VAL:
 *                 xdatab[i] = 1.e30             # <<<<<<<<<<<<<<
 *             elif radians:
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":116
 *             if projlonlatout.u == HUGE_VAL:
 *                 xdatab[i] = 1.e30
 *             elif radians:             # <<<<<<<<<<<<<<
 *                 xdatab[i] = projlonlatout.u
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":117
 *                 xdatab[i] = 1.e30
 *             elif radians:
 *                 xdatab[i] = projlonlatout.u             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":119
 *                 xdatab[i] = projlonlatout.u
 *             else:
 *                 xdatab[i] = _rad2dg*projlonlatout.u             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":120
 *             else:
 *                 xdatab[i] = _rad2dg*projlonlatout.u
 *             if projlonlatout.v == HUGE_VAL:             # <<<<<<<<<<<<<<
 *                 ydatab[i] = 1.e30
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":121
 *                 xdatab[i] = _rad2dg*projlonlatout.u
 *             if projlonlatout.v == HUGE_VAL:
 *                 ydatab[i] = 1.e30             # <<<<<<<<<<<<<<
 *             elif radians:
 ...
 */
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":122
 *             if projlonlatout.v == HUGE_VAL:
 *                 ydatab[i] = 1.e30
 *             elif radians:             # <<<<<<<<<<<<<<
 *                 ydatab[i] = projlonlatout.v
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":123
 *                 ydatab[i] = 1.e30
 *             elif radians:
 *                 ydatab[i] = projlonlatout.v             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":125
 *                 ydatab[i] = projlonlatout.v
 *             else:
 *                 ydatab[i] = _rad2dg*projlonlatout.v             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":199
...
static PyObject *__pyx_pf_5_proj_4Proj_is_latlong(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":202
 *         # returns True if projection in geographic (lon/lat) coordinates
 *         cdef int i
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":203
 *         cdef int i
 *         i = pj_is_latlong(self.projpj)
 *         if i:             # <<<<<<<<<<<<<<
 *             return True
 ...
 */
  if (__pyx_v_i) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":204
 *         i = pj_is_latlong(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":206
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":208
 *             return False
 * 
 *     def is_geocent(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5_proj_4Proj_is_geocent(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":211
 *         # returns True if projection in geocentric (x/y) coordinates
 *         cdef int i
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":212
 *         cdef int i
 *         i = pj_is_geocent(self.projpj)
 *         if i:             # <<<<<<<<<<<<<<
 *             return True
 ...
 */
  if (__pyx_v_i) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":213
 *         i = pj_is_geocent(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":215
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<<
 * 
...
/* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":217
 *             return False
 * 
 * def _transform(Proj p1, Proj p2, inx, iny, inz, radians):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5_proj__transform(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":222
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":223
 *     cdef Py_ssize_t buflenx, bufleny, buflenz, npts, i
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<<
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":224
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:             # <<<<<<<<<<<<<<
 *         raise RuntimeError
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":225
 *         raise RuntimeError
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":226
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":227
 *         raise RuntimeError
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":228
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":230
 *             raise RuntimeError
 *     else:
 *         buflenz = bufleny             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":231
 *     else:
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):             # <<<<<<<<<<<<<<
 *         raise RuntimeError('x,y and z must be same size')
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":232
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')             # <<<<<<<<<<<<<<
 *     xx = <double *>xdata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":233
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata             # <<<<<<<<<<<<<<
 *     yy = <double *>ydata
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":234
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata
 *     yy = <double *>ydata             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":235
 *     xx = <double *>xdata
 *     yy = <double *>ydata
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         zz = <double *>zdata
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":236
 *     yy = <double *>ydata
 *     if inz is not None:
 *         zz = <double *>zdata             # <<<<<<<<<<<<<<
 *     npts = buflenx/8
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":237
 *     if inz is not None:
 *         zz = <double *>zdata
 *     npts = buflenx/8             # <<<<<<<<<<<<<<
 *     if not radians and p1.is_latlong():
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":238
 *         zz = <double *>zdata
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":239
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<<
 *             xx[i] = xx[i]*_dg2rad
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":240
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad             # <<<<<<<<<<<<<<
 *             yy[i] = yy[i]*_dg2rad
 ...
 */
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":241
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":242
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":243
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":245
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)             # <<<<<<<<<<<<<<
 *     if ierr != 0:
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":246
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:             # <<<<<<<<<<<<<<
 *         raise RuntimeError(pj_strerrno(ierr))
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":247
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))             # <<<<<<<<<<<<<<
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 */
    __pyx_t_3 = PyBytes_FromString(pj_strerrno(__pyx_v_ierr)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 247; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":248
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":249
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<<
 *             xx[i] = xx[i]*_rad2dg
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":250
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg             # <<<<<<<<<<<<<<
 *             yy[i] = yy[i]*_rad2dg
 */
      ...
      /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":251
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg
 *             yy[i] = yy[i]*_rad2dg             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  /* "/mac_home/jwhitaker/python/pyproj/_proj.pyx":1
