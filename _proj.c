/* Generated by Cython 0.13 on Thu Dec 30 06:10:35 2010 */
...
/* "/Users/jsw/python/pyproj/_proj.pyx":14
 * cdef class Proj:
 *     cdef projPJ projpj
 *     cdef public object proj_version             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":83
 *                 if errcheck:
 *                     raise RuntimeError('projection undefined')
 *                 lonsdata[i] = 1.e30             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":85
 *                 lonsdata[i] = 1.e30
 *             else:
 *                 lonsdata[i] = projxyout.u             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (!__pyx_t_1) {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":87
 *                 lonsdata[i] = projxyout.u
 *             if projxyout.v == HUGE_VAL or\
 *                projxyout.u != projxyout.u:             # <<<<<<<<<<<<<<
 *                 if errcheck:
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":88
 *             if projxyout.v == HUGE_VAL or\
 *                projxyout.u != projxyout.u:
 *                 if errcheck:             # <<<<<<<<<<<<<<
 *                     raise RuntimeError('projection undefined')
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "/Users/jsw/python/pyproj/_proj.pyx":89
 *                projxyout.u != projxyout.u:
 *                 if errcheck:
 *                     raise RuntimeError('projection undefined')             # <<<<<<<<<<<<<<
 *                 latsdata[i] = 1.e30
 ...
 */
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":90
 *                 if errcheck:
 *                     raise RuntimeError('projection undefined')
 *                 latsdata[i] = 1.e30             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":92
 *                 latsdata[i] = 1.e30
 *             else:
 *                 latsdata[i] = projxyout.v             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":145
 *             if projlonlatout.v == HUGE_VAL or \
 *                projlonlatout.v != projlonlatout.v:
 *                 if errcheck:             # <<<<<<<<<<<<<<
 *                     raise RuntimeError('projection undefined')
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":229
 *         cdef int i
 *         i = pj_is_latlong(self.projpj)
 *         if i:             # <<<<<<<<<<<<<<
 *             return True
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":252
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":253
 *         raise RuntimeError
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":254
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":256
 *             raise RuntimeError
 *     else:
 *         buflenz = bufleny             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":257
 *     else:
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):             # <<<<<<<<<<<<<<
 *         raise RuntimeError('x,y and z must be same size')
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":258
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')             # <<<<<<<<<<<<<<
 *     xx = <double *>xdata
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":259
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata             # <<<<<<<<<<<<<<
 *     yy = <double *>ydata
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":260
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata
 *     yy = <double *>ydata             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":261
 *     xx = <double *>xdata
 *     yy = <double *>ydata
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         zz = <double *>zdata
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":262
 *     yy = <double *>ydata
 *     if inz is not None:
 *         zz = <double *>zdata             # <<<<<<<<<<<<<<
 *     npts = buflenx/8
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":263
 *     if inz is not None:
 *         zz = <double *>zdata
 *     npts = buflenx/8             # <<<<<<<<<<<<<<
 *     if not radians and p1.is_latlong():
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":264
 *         zz = <double *>zdata
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":265
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<<
 *             xx[i] = xx[i]*_dg2rad
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":266
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad             # <<<<<<<<<<<<<<
 *             yy[i] = yy[i]*_dg2rad
 ...
 */
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":267
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":268
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":269
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":271
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)             # <<<<<<<<<<<<<<
 *     if ierr != 0:
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":272
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:             # <<<<<<<<<<<<<<
 *         raise RuntimeError(pj_strerrno(ierr))
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":273
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))             # <<<<<<<<<<<<<<
 *     if not radians and p2.is_latlong():
 ...
 */
  ...
  /* "/Users/jsw/python/pyproj/_proj.pyx":274
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Users/jsw/python/pyproj/_proj.pyx":275
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<<
 *             xx[i] = xx[i]*_rad2dg
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":276
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg             # <<<<<<<<<<<<<<
 *             yy[i] = yy[i]*_rad2dg
 */
      ...
      /* "/Users/jsw/python/pyproj/_proj.pyx":277
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg
 *             yy[i] = yy[i]*_rad2dg             # <<<<<<<<<<<<<<
 */
