/* Generated by Cython 0.11.2 on Mon Nov  2 08:55:12 2009 */
...
/* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":199
...
static PyObject *__pyx_pf_5_proj_4Proj_is_latlong(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":202
 *         # returns True if projection in geographic (lon/lat) coordinates
 *         cdef int i
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":203
 *         cdef int i
 *         i = pj_is_latlong(self.projpj)
 *         if i:             # <<<<<<<<<<<<<<
 *             return True
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":204
 *         i = pj_is_latlong(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":206
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<<
 * 
...
/* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":208
 *             return False
 * 
 *     def is_geocent(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5_proj_4Proj_is_geocent(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":211
 *         # returns True if projection in geocentric (x/y) coordinates
 *         cdef int i
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":212
 *         cdef int i
 *         i = pj_is_geocent(self.projpj)
 *         if i:             # <<<<<<<<<<<<<<
 *             return True
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":213
 *         i = pj_is_geocent(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":215
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<<
 * 
...
/* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":217
 *             return False
 * 
 * def _transform(Proj p1, Proj p2, inx, iny, inz, radians):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5_proj__transform(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":222
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":223
 *     cdef Py_ssize_t buflenx, bufleny, buflenz, npts, i
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<<
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":224
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:             # <<<<<<<<<<<<<<
 *         raise RuntimeError
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":225
 *         raise RuntimeError
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":226
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":227
 *         raise RuntimeError
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":228
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":230
 *             raise RuntimeError
 *     else:
 *         buflenz = bufleny             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":231
 *     else:
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):             # <<<<<<<<<<<<<<
 *         raise RuntimeError('x,y and z must be same size')
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":232
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')             # <<<<<<<<<<<<<<
 *     xx = <double *>xdata
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":233
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata             # <<<<<<<<<<<<<<
 *     yy = <double *>ydata
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":234
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata
 *     yy = <double *>ydata             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":235
 *     xx = <double *>xdata
 *     yy = <double *>ydata
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         zz = <double *>zdata
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":236
 *     yy = <double *>ydata
 *     if inz is not None:
 *         zz = <double *>zdata             # <<<<<<<<<<<<<<
 *     npts = buflenx/8
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":237
 *     if inz is not None:
 *         zz = <double *>zdata
 *     npts = buflenx/8             # <<<<<<<<<<<<<<
 *     if not radians and p1.is_latlong():
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":238
 *         zz = <double *>zdata
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":239
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<<
 *             xx[i] = xx[i]*_dg2rad
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
      ...
      /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":240
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad             # <<<<<<<<<<<<<<
 *             yy[i] = yy[i]*_dg2rad
 ...
 */
      ...
      /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":241
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad             # <<<<<<<<<<<<<<
 *     if inz is not None:
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":242
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:             # <<<<<<<<<<<<<<
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":243
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":245
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)             # <<<<<<<<<<<<<<
 *     if ierr != 0:
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":246
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:             # <<<<<<<<<<<<<<
 *         raise RuntimeError(pj_strerrno(ierr))
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":247
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))             # <<<<<<<<<<<<<<
 *     if not radians and p2.is_latlong():
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":248
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":249
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<<
 *             xx[i] = xx[i]*_rad2dg
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_6; __pyx_v_i++) {
      ...
      /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":250
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg             # <<<<<<<<<<<<<<
 *             yy[i] = yy[i]*_rad2dg
 */
      ...
      /* "/Volumes/User/jwhitaker/python/pyproj/_proj.pyx":251
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg
 *             yy[i] = yy[i]*_rad2dg             # <<<<<<<<<<<<<<
 */
